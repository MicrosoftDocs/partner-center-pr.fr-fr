...
> [!NOTE]
> Pour plus d’informations sur la façon dont Microsoft émet un paiement pour le Marketplace commercial après une transaction, consultez détails de la [stratégie de paiement](payout-policy-details.md).
...
En général, nous envoyons les paiements dus le 15 du mois donné. Cependant, vous devrez prévoir un délai supplémentaire avant que le paiement parvienne à votre compte. Le nombre de jours varie selon le mode de paiement que nous utilisons pour votre compte, comme décrit ci-dessous.

| Mode de paiement | Délai approximatif du transfert sur le compte |
| --- | --- |
...
## <a name="payment-methods-in-countries-and-regions"></a>Modes de paiement dans les pays et les régions

Voici les pays et les régions dans lesquels les modes de paiement mentionnés ci-dessus sont employés pour chaque place de marché. Dans tous les cas, le seuil de paiement est de 50 USD.

| Pays/région | Place de marché Azure | Store, publicité, Mixer et Minecraft | Office | Paiements PayPal  |
| --- | --- | --- | --- | --- |
