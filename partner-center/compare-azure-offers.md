...
|Durée de la couverture|Actif jusqu’à annulation|Variables (dépendantes de l’offre)|Voir la description de l’offre|Toutes les réservations Azure ont leur période de couverture unique. Tous les abonnements serveur ont leur période de couverture unique|    Des licences supplémentaires basées sur les sièges sont alignées sur la période de couverture existante|
