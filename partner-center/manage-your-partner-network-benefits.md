...
## <a name="azure-and-cloud-products"></a>Produits Azure et cloud

L’onglet **Produits Azure et cloud** affiche les abonnements basés sur l’utilisation (crédit Azure) et les abonnements basés sur une licence (par exemple Office 365) qui vous sont provisionnés, la quantité de licences de chaque produit, le type d’offre qui vous a permis d’accéder à un avantage lié au produit, le type d’avantage (de base ou supplémentaire) ainsi que la date d’expiration de cet avantage.

:::image type="content" source="images/benefits/azuretab.png" alt-text="Onglet Produits Azure et cloud":::

### <a name="usage-based-subscriptions---microsoft-azure-credit"></a>Abonnements basés sur l’utilisation - Crédit Microsoft Azure

Il existe deux types d’abonnement basés sur l’utilisation que vous pouvez recevoir en fonction du type d’offre actif dont vous disposez en tant que partenaire MPN (MAPS, Silver et/ou Gold) : crédit mensuel ou crédit en bloc.

Vous pouvez être provisionné avec :

- 100 USD/mois (ou son équivalent en devise locale) de crédit mensuel Azure et/ou
- 6 000 USD, 12 000 USD et/ou 13 000 USD/an (ou leur équivalent en devise locale) de crédit en bloc Azure
...
>[!IMPORTANT]
>Notez qu’une fois qu’une clé est acceptée, elle ne peut pas être acceptée une seconde fois. Sachez donc clairement si vous devez ajouter plus de licences (sièges) ou étendre la date de fin. Si vous choisissez d’ajouter plus de licences au lieu d’étendre la date de fin, le système vous fournit moins de 12 mois d’abonnement actif. Vérifiez que vous êtes connecté à l’aide des informations d’identification appropriées pour activer les clés sur le locataire correspondant.
