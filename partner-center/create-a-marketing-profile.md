...
> [!IMPORTANT]  
> Pour aider nos partenaires à rationaliser les opérations de l’entreprise, nous allons consolidation des fonctionnalités et capacités qui permettant d’être réparties sur plusieurs outils et les sites Web dans l’espace partenaires, ce site. Dans le cadre de cet effort, nous avons déplacé toutes les fonctionnalités de références à l’espace partenaires et les sites Pinpoint et C2PC de mise hors service. Si vous avez utilisé Pinpoint ou C2PC dans le passé pour obtenir et gérer les redirections à partir de Microsoft, vous devez créer un nouveau profil d’entreprise dans l’espace partenaires pour continuer à obtenir des références. Nous ne prenons plus en charge l’importation de profils à partir de ces sites. 
...
2.  Dans la page **Create a business profile**, sélectionnez une région, puis saisissez les informations de votre profil.
    > [!NOTE]  
    >  L’espace partenaires prend en charge plusieurs langues, certains éléments, tels que la description et les balises au format libre, peut-être inclure le texte de différentes langues, comme mentionné plus haut dans cette rubrique.
...
*  **Balises axées sur le secteur**. Jusqu'à 5 secteurs
...
Comme vous preuves du succès avec les clients via l’espace partenaires, participez ou dans d’autres programmes ou les certifications Microsoft, nous allons ajouter automatiquement les mentions de vos produits spécifiques, services et des secteurs contribuer au succès de ce. Les approbations sont un facteur important dans les résultats de recherche.
...
Une fois que vous avez publié votre profil, les mises à jour apparaissent dans les recherches [Rechercher un partenaire](https://partnercenter.microsoft.com/pcv/search) dans un délai de 24 heures. 
