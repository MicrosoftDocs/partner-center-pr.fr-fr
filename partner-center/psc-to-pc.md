...
Comme vous le savez, votre entreprise perdra l’accès au PSC après le 31 décembre 2020. Vous trouverez tout ce que vous voulez faire pour gérer vos demandes et agir sur les transactions envoyées par les vendeurs Microsoft à vous dans l’espace partenaires. Toutefois, il y aura des différences, et les conseils suivants vous aideront à rendre votre transition vers l’espace partenaires plus lisse et directe.
...
Si votre entreprise dispose d’un système PDM, lorsque votre compte espace partenaires est configuré et que vos utilisateurs sont déplacés et disposent de rôles et d’autorisations, vous pouvez déplacer vos activités de covente vers l’espace partenaires. Informez le système PDM d’effectuer le basculement, ce qui permettra à toutes vos nouvelles demandes d’être transmises à l’espace partenaires.
>[!Note]
...
|Solutions|Les solutions appartenant à une seule liste de prix peuvent être ajoutées à un contrat.|Le partenaire peut ajouter des [solutions](https://docs.microsoft.com/partner-center/manage-co-sell-opportunities#add-solutions) qui appartiennent aux listes suivantes. a) leurs propres solutions b) à partir du catalogue Microsoft premier tiers (rôle commercial : transaction dans PSC) et c) coventent des solutions à partir d’autres partenaires tiers (rôle commercial : ISV dans PSC).|
...
### <a name="home-page-of-psc-and-default-view-of-the-co-sell-opportunities-in-partner-center"></a>Page d’hébergement du PSC et vue par défaut des opportunités de covente dans l’espace partenaires
...
### <a name="psc-grid-view-and-the-partner-center-deal-view"></a>Affichage de grille du PSC et vue des transactions de l’espace partenaires
...
### <a name="deal-details-view-in-psc-and-partner-center"></a>Vue des détails de la transaction dans PSC et l’espace partenaires
...
- La date de fermeture de la solution estimée est disponible uniquement pour les contrats IOT OEM. Elle n’est pas affichée pour d’autres types de transactions.
...
### <a name="psc-add-products-view-and-the-partner-center-add-solutions-view"></a>Vue d’ensemble du PSC ajouter des produits et de la vue ajouter des solutions de l’espace partenaires
...
### <a name="user-management-in-psc-and-partner-center"></a>Gestion des utilisateurs dans PSC et l’espace partenaires
...
### <a name="user-role-assignment-in-psc-and-partner-center"></a>Attribution de rôle d’utilisateur dans PSC et l’espace partenaires
...
- Tous les responsables des transactions et les vendeurs du PSC doivent être affectés d’un rôle d’administrateur de référence.
...
### <a name="notifications-in-psc-and-partner-center"></a>Notifications dans PSC et l’espace partenaires
...
### <a name="q-the-new-deal-button-is-greyed-out-for-our-account-what-should-i-do-to-start-creating-deals"></a>Q. Le bouton + nouveau contrat est grisé pour notre compte. Que dois-je faire pour commencer à créer des transactions ?
...
### <a name="q-can-i-assign-deals-to-a-specific-person-from-our-organization-like-psc"></a>Q. Puis-je attribuer des transactions à une personne spécifique de notre organisation, comme PSC ?
...
### <a name="q-is-there-a-view-of-all-the-deals-assigned-to-me"></a>Q. Existe-t-il une vue de toutes les transactions qui me sont attribuées ?
...
### <a name="q-is-there-a-read-only-view-for-the-deals"></a>Q. Existe-t-il une vue en lecture seule des transactions ?
...
### <a name="q-how-can-i-register-a-deal-after-making-it-as-won"></a>Q. Comment puis-je inscrire un contrat après l’avoir gagné ?
...
### <a name="q-i-get-an-error-message-when-i-click-on-new-deal-registration-button-in-the-deal-registration-section-how-can-i-register-my-deals"></a>Q. J’obtiens un message d’erreur lorsque je clique sur le bouton « + nouvel enregistrement de la transaction » dans la section d’enregistrement des transactions. Comment puis-je inscrire mes demandes ?
...
### <a name="q-is-adding-a-customer-organization-mandatory"></a>Q. L’ajout d’une organisation client est-il obligatoire ?
...
### <a name="q-are-customer-contact-details-mandatory"></a>Q. Les coordonnées du client sont-elles obligatoires ?
...
### <a name="q-how-many-solutions-can-i-add-to-a-deal"></a>Q. Combien de solutions puis-je ajouter à un contrat ?
...
### <a name="q-when-will-i-get-to-know-the-microsoft-seller-details-after-creating-a-deal"></a>Q. Quand dois-je connaître les détails du vendeur Microsoft après avoir créé un contrat ?
...
### <a name="q-where-can-i-find-the-opportunity-id"></a>Q. Où puis-je trouver l’ID d’opportunité ?
...
### <a name="q-how-can-my-pdm-get-access-to-pc"></a>Q. Comment mon PDM peut-il accéder à un PC ?
