...
**Ajouter ou supprimer des licences utilisateur pour un client**
...
**Réinitialiser un mot de passe utilisateur pour un client**
...
**Restaurer les comptes d’utilisateur supprimé**
