...
Pour acheter un abonnement SaaS basé sur une licence dans l’espace partenaires, consultez [créer, suspendre ou annuler des abonnements client](create-a-new-subscription.md#create-a-new-subscription).
