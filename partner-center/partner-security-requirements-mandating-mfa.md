...
* Toutes les pages sous l’onglet **Support > Customer requests** .
...
2. Pour créer une demande de service partenaire, accédez à la **prise en charge** > **demandes de support partenaires** , puis cliquez sur **nouvelle requête**.
