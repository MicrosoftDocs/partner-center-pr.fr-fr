...
### <a name="categories"></a><span data-ttu-id="3d7a4-108">Catégories</span><span class="sxs-lookup"><span data-stu-id="3d7a4-108">Categories</span></span>
...
### <a name="partner-benefits"></a><span data-ttu-id="3d7a4-131">Avantages pour les partenaires</span><span class="sxs-lookup"><span data-stu-id="3d7a4-131">Partner benefits</span></span>
...
### <a name="change-log"></a><span data-ttu-id="3d7a4-141">Journal des modifications</span><span class="sxs-lookup"><span data-stu-id="3d7a4-141">Change log</span></span>
...
- <span data-ttu-id="3d7a4-204">Date de lancement fournie</span><span class="sxs-lookup"><span data-stu-id="3d7a4-204">Launch Date provided</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="3d7a4-216">Étapes suivantes</span><span class="sxs-lookup"><span data-stu-id="3d7a4-216">Next steps</span></span>
...
<span data-ttu-id="3d7a4-226">Tous les partenaires fournisseurs de solutions Cloud</span><span class="sxs-lookup"><span data-stu-id="3d7a4-226">All CSP partners</span></span>
...
### <a name="categories"></a><span data-ttu-id="3d7a4-239">Catégories</span><span class="sxs-lookup"><span data-stu-id="3d7a4-239">Categories</span></span>
...
<span data-ttu-id="3d7a4-250">La nouvelle expérience commerciale offre les avantages suivants :</span><span class="sxs-lookup"><span data-stu-id="3d7a4-250">The new commerce experience delivers the following benefits:</span></span>
...
<span data-ttu-id="3d7a4-287">Les partenaires sont vivement encouragés à se familiariser avec les ressources suivantes :</span><span class="sxs-lookup"><span data-stu-id="3d7a4-287">Partners are highly encouraged to familiarize themselves with the following resources:</span></span>
...
### <a name="categories"></a><span data-ttu-id="3d7a4-299">Catégories</span><span class="sxs-lookup"><span data-stu-id="3d7a4-299">Categories</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="3d7a4-312">Étapes suivantes</span><span class="sxs-lookup"><span data-stu-id="3d7a4-312">Next steps</span></span>
...
<span data-ttu-id="3d7a4-336">L’Espace partenaires est conçu pour gérer un gros volume de requêtes, mais si un nombre excessif de requêtes est le fait de quelques partenaires, la limitation permet de maintenir un niveau de performance et une fiabilité optimum pour tous les partenaires.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-336">Partner Center is designed to handle a high volume of requests, but if an overwhelming number of requests are made by a few partners, throttling will help maintain optimal performance and reliability for all partners.</span></span>  
...
### <a name="impacted-audience"></a><span data-ttu-id="3d7a4-376">Public concerné</span><span class="sxs-lookup"><span data-stu-id="3d7a4-376">Impacted audience</span></span>
...
<span data-ttu-id="3d7a4-398">Une extension accessible aux clients disposant de Microsoft 365 E5 (prérequis) permettra à ceux-ci de conserver leurs données pendant 10 ans.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-398">An add-on available with a prerequisite of Microsoft 365 E5 will enable customers to hold their data for 10 years.</span></span> 
   ...
   |<span data-ttu-id="3d7a4-399">**Nom de l'offre**</span><span class="sxs-lookup"><span data-stu-id="3d7a4-399">**Offer name**</span></span>|<span data-ttu-id="3d7a4-400">**ID de l’offre**</span><span class="sxs-lookup"><span data-stu-id="3d7a4-400">**Offer ID**</span></span>|<span data-ttu-id="3d7a4-401">**ID de contenu**</span><span class="sxs-lookup"><span data-stu-id="3d7a4-401">**Material ID**</span></span>|
   |-------------------|:------|:------|
...
<span data-ttu-id="3d7a4-425">Passez en revue la préversion du tarif et partagez-la avec les parties prenantes appropriées au sein de votre organisation.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-425">Review the price list preview and share with the appropriate stakeholders in your organization.</span></span> <span data-ttu-id="3d7a4-426">Pour plus d’informations, consultez [Microsoft Security and Compliance - Microsoft Tech Community](https://techcommunity.microsoft.com/t5/microsoft-security-and/ct-p/MicrosoftSecurityandCompliance).</span><span class="sxs-lookup"><span data-stu-id="3d7a4-426">For more information, go to [Microsoft Security and Compliance - Microsoft Tech Community](https://techcommunity.microsoft.com/t5/microsoft-security-and/ct-p/MicrosoftSecurityandCompliance).</span></span>

### <a name="questions"></a><span data-ttu-id="3d7a4-427">Vous avez des questions ?</span><span class="sxs-lookup"><span data-stu-id="3d7a4-427">Questions?</span></span>

<span data-ttu-id="3d7a4-428">Si vous avez d’autres questions sur ces offres, consultez vos communautés Yammer appropriées.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-428">For any further questions about these offers, check your relevant Yammer communities.</span></span> 

_____________ 

## <a name="docusign-migration-to-adobe-sign-for-partners-under-microsoft-partner-agreements-mpas"></a><a name="7"></a><span data-ttu-id="3d7a4-429">Migration de DocuSign vers Adobe Sign pour les partenaires sous contrat Partenaire Microsoft (MPA)</span><span class="sxs-lookup"><span data-stu-id="3d7a4-429">DocuSign migration to Adobe Sign for partners under Microsoft Partner Agreements (MPAs)</span></span> 

### <a name="categories"></a><span data-ttu-id="3d7a4-430">Catégories</span><span class="sxs-lookup"><span data-stu-id="3d7a4-430">Categories</span></span>

- <span data-ttu-id="3d7a4-431">Date : 15-01-2021</span><span class="sxs-lookup"><span data-stu-id="3d7a4-431">Date: 2021-01-15</span></span>
- <span data-ttu-id="3d7a4-432">Fonctions</span><span class="sxs-lookup"><span data-stu-id="3d7a4-432">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="3d7a4-433">Résumé</span><span class="sxs-lookup"><span data-stu-id="3d7a4-433">Summary</span></span>

<span data-ttu-id="3d7a4-434">Microsoft fera passer l’ensemble du traitement des signatures électroniques de DocuSign vers Adobe Sign.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-434">Microsoft will be transitioning all electronic signature processing from DocuSign to Adobe Sign.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="3d7a4-435">Public concerné</span><span class="sxs-lookup"><span data-stu-id="3d7a4-435">Impacted audience</span></span>

<span data-ttu-id="3d7a4-436">Partenaires fournisseurs de solutions Cloud directs et indirects existants sous contrat MPA.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-436">Existing direct and indirect Cloud Solution Provider (CSP) partners under MPA.</span></span> <span data-ttu-id="3d7a4-437">Les partenaires situés en Ukraine, en Russie et au Kazakhstan seront tenus de resigner physiquement ou par voie électronique un avenant annuel.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-437">Partners in Ukraine, Russia, and Kazakhstan will be required to physically or electronically re-sign the Rider annually.</span></span>

### <a name="details"></a><span data-ttu-id="3d7a4-438">Détails</span><span class="sxs-lookup"><span data-stu-id="3d7a4-438">Details</span></span>

<span data-ttu-id="3d7a4-439">En février 2021, Microsoft commencera à opérer la transition de l’ensemble du traitement des signatures électroniques de DocuSign vers Adobe Sign pour les partenaires fournisseurs de solutions Cloud.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-439">In February 2021, Microsoft will begin transitioning all electronic signature processing from DocuSign to Adobe Sign for CSP partners.</span></span> 

<span data-ttu-id="3d7a4-440">Vous devez vous attendre à une transition en douceur.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-440">You should expect a smooth transition.</span></span> <span data-ttu-id="3d7a4-441">Une fois la migration effectuée, vous recevrez un e-mail de adobesign@adobesign.com, et non de DocuSign, chaque fois que votre signature électronique sera requise.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-441">Upon migration, you will receive an email from adobesign@adobesign.com, instead of DocuSign, whenever your electronic signature is required.</span></span> <span data-ttu-id="3d7a4-442">Vous trouverez dans cet e-mail un lien vers la page web Adobe Sign dans laquelle vous devrez déposer votre signature.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-442">This email will provide you with a link to the Adobe Sign web page where you will need to sign.</span></span> <span data-ttu-id="3d7a4-443">Les partenaires Microsoft n’auront pas à resigner les contrats existants, mais seulement les futurs contrats de distribution.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-443">Microsoft partners will not have to re-sign existing agreements, only future Channel Agreements.</span></span> 

<span data-ttu-id="3d7a4-444">Vous trouverez un exemple d’e-mail de demande Adobe Sign dans la [galerie de ressources](https://partner.microsoft.com/resources/detail/adobe-sign-signature-request-email-pdf).</span><span class="sxs-lookup"><span data-stu-id="3d7a4-444">You can find an example of an Adobe Sign signature request email in [the resource gallery](https://partner.microsoft.com/resources/detail/adobe-sign-signature-request-email-pdf).</span></span> 

<span data-ttu-id="3d7a4-445">**Pour une expérience optimale, veillez à effectuer ce qui suit :**</span><span class="sxs-lookup"><span data-stu-id="3d7a4-445">**For the best experience, make sure to do the following:**</span></span>

1. <span data-ttu-id="3d7a4-446">Ajoutez adobesign@adobesign.com à votre liste d’expéditeurs approuvés pour éviter que les e-mails en provenance de ce compte atterrissent directement dans votre dossier de courrier indésirable.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-446">Add adobesign@adobesign.com to your safe senders list to avoid emails from this account going directly into your junk email folder.</span></span>
2. <span data-ttu-id="3d7a4-447">Rapprochez-vous de votre service informatique pour :</span><span class="sxs-lookup"><span data-stu-id="3d7a4-447">Work with your IT department to:</span></span>
   - <span data-ttu-id="3d7a4-448">Ajouter l’adresse e-mail adobesign@adobesign.com à la liste des expéditeurs approuvés pour faire en sorte qu’elle ne soit pas incluse dans une règle d’hameçonnage préétablie.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-448">Add the adobesign@adobesign.com email address to their safe senders list to ensure that it’s not included in any pre-established phishing rule.</span></span>
   - <span data-ttu-id="3d7a4-449">Mettez à jour les stratégies de sécurité existantes de sorte que tous les destinataires requis puissent signer la documentation dans le cadre de votre licence d’entreprise Adobe Sign.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-449">Update existing security policies to ensure that all required recipients can sign documentation under your Adobe Sign enterprise license.</span></span>

<span data-ttu-id="3d7a4-450">Adobe Sign est la solution de signature électronique préférée de Microsoft.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-450">Adobe Sign is Microsoft’s preferred Electronic Signature Solution (ESS).</span></span> <span data-ttu-id="3d7a4-451">La transition vers Adobe Sign garantira une expérience de signature électronique sécurisée et efficace, qui offrira une valeur ajoutée à nos clients et partenaires.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-451">The transition to Adobe Sign will ensure a secure and efficient electronic signature experience that will deliver greater value to our customers and partners.</span></span>

<span data-ttu-id="3d7a4-452">Pour plus d’informations sur la façon de signer électroniquement les documents et sur la délégation des signatures électroniques, consultez les **tutoriels** suivants :</span><span class="sxs-lookup"><span data-stu-id="3d7a4-452">For additional information on how to electronically sign documents and electronic signature delegation, refer to the following **tutorials**:</span></span> 
- [<span data-ttu-id="3d7a4-453">Electronically sign a document | Tutoriels Adobe Sign</span><span class="sxs-lookup"><span data-stu-id="3d7a4-453">Electronically sign a document | Adobe Sign tutorials</span></span>](https://helpx.adobe.com/sign/how-to/adobe-for-signers.html?playlist=/ccx/v1/collection/product/sign/segment/designer/explevel/beginner/applaunch/continuinged/collection.ccx.js&ref=helpx.adobe.com)
- [<span data-ttu-id="3d7a4-454">Delegate someone else to sign a document | Tutoriels Adobe Sign</span><span class="sxs-lookup"><span data-stu-id="3d7a4-454">Delegate someone else to sign a document | Adobe Sign tutorials</span></span>](https://helpx.adobe.com/sign/how-to/use-the-delegator-role.html?playlist=/ccx/v1/collection/product/sign/segment/designer/explevel/beginner/applaunch/orientation/collection.ccx.js&ref=helpx.adobe.com)

### <a name="next-steps"></a><span data-ttu-id="3d7a4-455">Étapes suivantes</span><span class="sxs-lookup"><span data-stu-id="3d7a4-455">Next steps</span></span>

<span data-ttu-id="3d7a4-456">Partagez ces informations avec les parties prenantes concernées de votre organisation.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-456">Share this information with the appropriate stakeholders in your organization.</span></span>

### <a name="questions"></a><span data-ttu-id="3d7a4-457">Des questions ?</span><span class="sxs-lookup"><span data-stu-id="3d7a4-457">Questions?</span></span>

<span data-ttu-id="3d7a4-458">Si vous avez des questions, contactez votre centre régional des opérations en utilisant l’outil [CLT (Call Logging Tool)](https://clt.partners.extranet.microsoft.com/CLT) ou via [Explore MS](https://www.explore.ms/).</span><span class="sxs-lookup"><span data-stu-id="3d7a4-458">If you have any questions, contact your Regional Operations Center using the [Call Logging Tool (CLT)](https://clt.partners.extranet.microsoft.com/CLT) or at [Explore MS](https://www.explore.ms/).</span></span> <span data-ttu-id="3d7a4-459">Suivez précisément le processus CLT standard pour nous permettre de résoudre votre requête aussi rapidement que possible.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-459">Follow the standard CLT process closely so that we can resolve your query as quickly as possible.</span></span>

_____________ 

## <a name="commercial-pricing-update-for-norwegian-krone"></a><a name="6"></a><span data-ttu-id="3d7a4-460">Mise à jour des prix appliqués pour la couronne norvégienne</span><span class="sxs-lookup"><span data-stu-id="3d7a4-460">Commercial pricing update for Norwegian krone</span></span> 

### <a name="categories"></a><span data-ttu-id="3d7a4-461">Catégories</span><span class="sxs-lookup"><span data-stu-id="3d7a4-461">Categories</span></span>

- <span data-ttu-id="3d7a4-462">Date : 14-01-2021</span><span class="sxs-lookup"><span data-stu-id="3d7a4-462">Date: 2021-01-14</span></span>
- <span data-ttu-id="3d7a4-463">Offres/marchés</span><span class="sxs-lookup"><span data-stu-id="3d7a4-463">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="3d7a4-464">Public concerné</span><span class="sxs-lookup"><span data-stu-id="3d7a4-464">Impacted audience</span></span>

<span data-ttu-id="3d7a4-465">Partenaires fournisseurs de solutions Cloud utilisant la couronne norvégienne.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-465">Cloud Solution Provider partners using the Norwegian krone.</span></span>

### <a name="details"></a><span data-ttu-id="3d7a4-466">Détails</span><span class="sxs-lookup"><span data-stu-id="3d7a4-466">Details</span></span>

<span data-ttu-id="3d7a4-467">À partir du 1er mars 2021, les prix exprimés en couronne norvégienne pour les logiciels locaux et les services en ligne commerciaux changeront pour être réalignés sur les niveaux de prix en vigueur dans la région.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-467">From March 1, 2021, Norwegian krone prices for commercial on-premises software and online services will change to realign with prevailing pricing levels in the region.</span></span>
<span data-ttu-id="3d7a4-468">L’annonce complète est accessible uniquement aux partenaires Microsoft.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-468">The full announcement is available only to Microsoft partners.</span></span> <span data-ttu-id="3d7a4-469">[Connectez-vous pour accéder à l’annonce complète](https://partner.microsoft.com/resources/detail/pricing-update-norway-partners-pdf).</span><span class="sxs-lookup"><span data-stu-id="3d7a4-469">[Sign in to access the full announcement](https://partner.microsoft.com/resources/detail/pricing-update-norway-partners-pdf).</span></span>

_____________ 

## <a name="commercial-pricing-update-for-the-indian-rupee"></a><a name="5"></a><span data-ttu-id="3d7a4-470">Mise à jour des prix appliqués pour la roupie indienne</span><span class="sxs-lookup"><span data-stu-id="3d7a4-470">Commercial pricing update for the Indian rupee</span></span> 

### <a name="categories"></a><span data-ttu-id="3d7a4-471">Catégories</span><span class="sxs-lookup"><span data-stu-id="3d7a4-471">Categories</span></span>

- <span data-ttu-id="3d7a4-472">Date : 08-01-2021</span><span class="sxs-lookup"><span data-stu-id="3d7a4-472">Date: 2021-01-08</span></span>
- <span data-ttu-id="3d7a4-473">Offres/marchés</span><span class="sxs-lookup"><span data-stu-id="3d7a4-473">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="3d7a4-474">Public concerné</span><span class="sxs-lookup"><span data-stu-id="3d7a4-474">Impacted audience</span></span>

<span data-ttu-id="3d7a4-475">Tous partenaires fournisseurs de solutions Cloud effectuant des transactions en Inde.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-475">CSP partners transacting in India.</span></span>

### <a name="details"></a><span data-ttu-id="3d7a4-476">Détails</span><span class="sxs-lookup"><span data-stu-id="3d7a4-476">Details</span></span> 

<span data-ttu-id="3d7a4-477">Microsoft apporte des modifications à la liste des prix en roupies indiennes pour aligner les prix des logiciels commerciaux et des services en ligne en Inde et dans la région asiatique.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-477">Microsoft is making changes to the Indian rupee price list to align prices for commercial software and online services within India and the Asian region.</span></span>

<span data-ttu-id="3d7a4-478">L’annonce complète est disponible seulement pour les partenaires Microsoft.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-478">The full announcement is only available to Microsoft Partners.</span></span> <span data-ttu-id="3d7a4-479">[Connectez-vous pour accéder à l’annonce complète](https://partner.microsoft.com/resources/detail/price-update-indian-rupee.pdf).</span><span class="sxs-lookup"><span data-stu-id="3d7a4-479">[Login to access the full announcement](https://partner.microsoft.com/resources/detail/price-update-indian-rupee.pdf).</span></span>

________________

## <a name="calling-plan-and-phone-system-updates-for-february-1-2021"></a><a name="4"></a><span data-ttu-id="3d7a4-480">Mises à jour des forfaits d’appels et des systèmes téléphoniques au 1er février 2021</span><span class="sxs-lookup"><span data-stu-id="3d7a4-480">Calling Plan and Phone System updates for February 1, 2021</span></span>

### <a name="categories"></a><span data-ttu-id="3d7a4-481">Catégories</span><span class="sxs-lookup"><span data-stu-id="3d7a4-481">Categories</span></span>

- <span data-ttu-id="3d7a4-482">Date : 08-01-2021</span><span class="sxs-lookup"><span data-stu-id="3d7a4-482">Date: 2021-01-08</span></span>
- <span data-ttu-id="3d7a4-483">Offres/marchés</span><span class="sxs-lookup"><span data-stu-id="3d7a4-483">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="3d7a4-484">Résumé</span><span class="sxs-lookup"><span data-stu-id="3d7a4-484">Summary</span></span>

<span data-ttu-id="3d7a4-485">Une offre complémentaire à Microsoft 365, qui inclura le système téléphonique et le forfait d’appels nationaux, et un forfait d’appels nationaux autonome, sera bientôt disponible dans certains pays.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-485">An add-on offer to Microsoft 365, which will include Phone System and Domestic Calling Plan and a standalone Domestic Calling Plan, is coming soon to select countries.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="3d7a4-486">Public concerné</span><span class="sxs-lookup"><span data-stu-id="3d7a4-486">Impacted audience</span></span>

<span data-ttu-id="3d7a4-487">Tous les partenaires vendant dans le cadre du programme Fournisseur de solutions cloud.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-487">All partners transacting through the Cloud Solution Provider (CSP) program.</span></span>

### <a name="details"></a><span data-ttu-id="3d7a4-488">Détails</span><span class="sxs-lookup"><span data-stu-id="3d7a4-488">Details</span></span> 

<span data-ttu-id="3d7a4-489">L’offre en bundle complémentaire aux offres Microsoft 365 E1, E3 et E5 inclut le système téléphonique et le forfait d’appels nationaux.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-489">The add-on bundled offer to Microsoft 365 E1, E3, and E5 offers will include Phone System and Domestic Calling Plan.</span></span> <span data-ttu-id="3d7a4-490">En outre, une nouvelle offre de forfait d’appels nationaux autonome sera disponible seulement pour E5.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-490">In addition, a new standalone Domestic Calling Plan offer will be available for E5 only.</span></span> <span data-ttu-id="3d7a4-491">Les nouvelles offres seront disponibles pour les clients aux États-Unis, à Porto Rico et au Canada uniquement ; pour tous les autres pays et territoires, les références SKU autonomes mondiales existantes et la tarification restent identiques.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-491">The new offers will be available to customers in the US, Puerto Rico, and Canada only; for all other countries and territories, the existing global standalone SKUs and pricing remain the same.</span></span> 

<span data-ttu-id="3d7a4-492">Ces offres sont disponibles pour les clients commerciaux, les étudiants, les universités, le Cloud de la communauté du secteur public (GCC) et les clients sans but lucratif aux États-Unis, à Porto Rico et au Canada.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-492">These offers will be available to Commercial, Student, Faculty, Government Community Cloud (GCC), and Nonprofit customers in the US, Puerto Rico, and Canada.</span></span> <span data-ttu-id="3d7a4-493">Les forfaits d’appels ne sont pas disponibles dans les autres territoires des États-Unis.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-493">Calling plans are not available in any of the other US territories.</span></span>

   |<span data-ttu-id="3d7a4-494">**Nom de l'offre**</span><span class="sxs-lookup"><span data-stu-id="3d7a4-494">**Offer name**</span></span>|<span data-ttu-id="3d7a4-495">**ID de l’offre**</span><span class="sxs-lookup"><span data-stu-id="3d7a4-495">**Offer ID**</span></span>|<span data-ttu-id="3d7a4-496">**ID de contenu**</span><span class="sxs-lookup"><span data-stu-id="3d7a4-496">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="3d7a4-497">Microsoft Teams Calling Essentials for US and Canada</span><span class="sxs-lookup"><span data-stu-id="3d7a4-497">Microsoft Teams Calling Essentials for US and Canada</span></span>|<span data-ttu-id="3d7a4-498">1ee81de6-4d8b-4cf1-b926-2fd2a774a4ca</span><span class="sxs-lookup"><span data-stu-id="3d7a4-498">1ee81de6-4d8b-4cf1-b926-2fd2a774a4ca</span></span>|<span data-ttu-id="3d7a4-499">8N2-00010</span><span class="sxs-lookup"><span data-stu-id="3d7a4-499">8N2-00010</span></span>|
   |<span data-ttu-id="3d7a4-500">Microsoft Teams Calling Essentials for US and Canada (Nonprofit Staff Pricing)</span><span class="sxs-lookup"><span data-stu-id="3d7a4-500">Microsoft Teams Calling Essentials for US and Canada (Nonprofit Staff Pricing)</span></span>|<span data-ttu-id="3d7a4-501">0c2ece0d-39b7-40ec-8c08-87c2b6c75d62</span><span class="sxs-lookup"><span data-stu-id="3d7a4-501">0c2ece0d-39b7-40ec-8c08-87c2b6c75d62</span></span>|<span data-ttu-id="3d7a4-502">8N2-00011</span><span class="sxs-lookup"><span data-stu-id="3d7a4-502">8N2-00011</span></span>|
   |<span data-ttu-id="3d7a4-503">Microsoft Teams Calling Essentials for US and Canada for faculty</span><span class="sxs-lookup"><span data-stu-id="3d7a4-503">Microsoft Teams Calling Essentials for US and Canada for faculty</span></span>|<span data-ttu-id="3d7a4-504">b8baa3b8-8cc2-4f26-a212-7fbeb28e7895</span><span class="sxs-lookup"><span data-stu-id="3d7a4-504">b8baa3b8-8cc2-4f26-a212-7fbeb28e7895</span></span>|<span data-ttu-id="3d7a4-505">8N3-00003</span><span class="sxs-lookup"><span data-stu-id="3d7a4-505">8N3-00003</span></span>|
   |<span data-ttu-id="3d7a4-506">Microsoft Teams Calling Essentials for US and Canada for students</span><span class="sxs-lookup"><span data-stu-id="3d7a4-506">Microsoft Teams Calling Essentials for US and Canada for students</span></span>|<span data-ttu-id="3d7a4-507">26956da8-eeb5-44e3-aa79-d36e0e42b930</span><span class="sxs-lookup"><span data-stu-id="3d7a4-507">26956da8-eeb5-44e3-aa79-d36e0e42b930</span></span>|<span data-ttu-id="3d7a4-508">8N3-00004</span><span class="sxs-lookup"><span data-stu-id="3d7a4-508">8N3-00004</span></span>|
   |<span data-ttu-id="3d7a4-509">Microsoft Teams Calling Essentials for US and Canada for GCC</span><span class="sxs-lookup"><span data-stu-id="3d7a4-509">Microsoft Teams Calling Essentials for US and Canada for GCC</span></span>|<span data-ttu-id="3d7a4-510">7a2e2d5a-41b5-4b20-a0d1-0d06d34b5fe1</span><span class="sxs-lookup"><span data-stu-id="3d7a4-510">7a2e2d5a-41b5-4b20-a0d1-0d06d34b5fe1</span></span>|<span data-ttu-id="3d7a4-511">8N4-00002</span><span class="sxs-lookup"><span data-stu-id="3d7a4-511">8N4-00002</span></span>|
   |<span data-ttu-id="3d7a4-512">Microsoft 365 Domestic Calling Plan for US and Canada</span><span class="sxs-lookup"><span data-stu-id="3d7a4-512">Microsoft 365 Domestic Calling Plan for US and Canada</span></span>|<span data-ttu-id="3d7a4-513">60d2919e-427a-46c9-bd03-89cbad27d53f</span><span class="sxs-lookup"><span data-stu-id="3d7a4-513">60d2919e-427a-46c9-bd03-89cbad27d53f</span></span>|<span data-ttu-id="3d7a4-514">TK2-00050</span><span class="sxs-lookup"><span data-stu-id="3d7a4-514">TK2-00050</span></span>|
   |<span data-ttu-id="3d7a4-515">Microsoft 365 Domestic Calling Plan for faculty for US and Canada</span><span class="sxs-lookup"><span data-stu-id="3d7a4-515">Microsoft 365 Domestic Calling Plan for faculty for US and Canada</span></span>|<span data-ttu-id="3d7a4-516">602e7548-375b-4e01-bf79-a9a8b8ff16d4</span><span class="sxs-lookup"><span data-stu-id="3d7a4-516">602e7548-375b-4e01-bf79-a9a8b8ff16d4</span></span>|<span data-ttu-id="3d7a4-517">LM7-00006</span><span class="sxs-lookup"><span data-stu-id="3d7a4-517">LM7-00006</span></span>|
   |<span data-ttu-id="3d7a4-518">Microsoft 365 Domestic Calling Plan for students for US and Canada</span><span class="sxs-lookup"><span data-stu-id="3d7a4-518">Microsoft 365 Domestic Calling Plan for students for US and Canada</span></span>|<span data-ttu-id="3d7a4-519">1f4b4375-3185-40cf-b044-117fe3b102c6</span><span class="sxs-lookup"><span data-stu-id="3d7a4-519">1f4b4375-3185-40cf-b044-117fe3b102c6</span></span>|<span data-ttu-id="3d7a4-520">LM7-00007</span><span class="sxs-lookup"><span data-stu-id="3d7a4-520">LM7-00007</span></span>|
   |<span data-ttu-id="3d7a4-521">Microsoft 365 Domestic Calling Plan for GCC for US and Canada</span><span class="sxs-lookup"><span data-stu-id="3d7a4-521">Microsoft 365 Domestic Calling Plan for GCC for US and Canada</span></span>|<span data-ttu-id="3d7a4-522">594ed84e-ddf8-4e40-9726-76c04bd29e3b</span><span class="sxs-lookup"><span data-stu-id="3d7a4-522">594ed84e-ddf8-4e40-9726-76c04bd29e3b</span></span>|<span data-ttu-id="3d7a4-523">LM9-00023</span><span class="sxs-lookup"><span data-stu-id="3d7a4-523">LM9-00023</span></span>|

### <a name="next-steps"></a><span data-ttu-id="3d7a4-524">Étapes suivantes</span><span class="sxs-lookup"><span data-stu-id="3d7a4-524">Next steps</span></span>

- <span data-ttu-id="3d7a4-525">Fournissez ces informations aux personnes concernées de votre organisation et découvrez les opportunités de ventes incitatives et de ventes croisées.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-525">Share this information with the relevant contacts in your organization and understand the upsell and cross-sell opportunities.</span></span> 
- <span data-ttu-id="3d7a4-526">Consultez la section Ressources du [Guide des partenaires Teams](https://aka.ms/teamscallingmeetingsguide).</span><span class="sxs-lookup"><span data-stu-id="3d7a4-526">Review the resources section of the [Teams Partner Guide](https://aka.ms/teamscallingmeetingsguide).</span></span>

_____________ 

## <a name="license-base-price-list-updates-for-january-2021"></a><a name="3"></a><span data-ttu-id="3d7a4-527">Mises à jour de la liste des prix des licences pour janvier 2021</span><span class="sxs-lookup"><span data-stu-id="3d7a4-527">License-base price list updates for January 2021</span></span> 

### <a name="categories"></a><span data-ttu-id="3d7a4-528">Catégories</span><span class="sxs-lookup"><span data-stu-id="3d7a4-528">Categories</span></span>

- <span data-ttu-id="3d7a4-529">Date : 08-01-2021</span><span class="sxs-lookup"><span data-stu-id="3d7a4-529">Date: 2021-01-08</span></span>
- <span data-ttu-id="3d7a4-530">Offres/marchés</span><span class="sxs-lookup"><span data-stu-id="3d7a4-530">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="3d7a4-531">Résumé</span><span class="sxs-lookup"><span data-stu-id="3d7a4-531">Summary</span></span>

<span data-ttu-id="3d7a4-532">Les listes de prix de janvier et février pour les offres basées sur des licences ont été mises à jour pour corriger certains prix incorrects dans les listes.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-532">January and February price lists for license-based offers have been updated to correct certain incorrect list prices.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="3d7a4-533">Public concerné</span><span class="sxs-lookup"><span data-stu-id="3d7a4-533">Impacted audience</span></span>

<span data-ttu-id="3d7a4-534">Tous les partenaires vendant dans le cadre du programme Fournisseur de solutions cloud.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-534">All partners transacting through the Cloud Solution Provider (CSP) program.</span></span>

### <a name="details"></a><span data-ttu-id="3d7a4-535">Détails</span><span class="sxs-lookup"><span data-stu-id="3d7a4-535">Details</span></span> 

<span data-ttu-id="3d7a4-536">Les listes de prix basés sur une licence pour le janvier 2021 et février 2021 comportaient quelques prix incorrects.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-536">The license-based price lists for January 2021 and February 2021 included a few incorrect list prices.</span></span> <span data-ttu-id="3d7a4-537">Les offres et les devises affectées figurent ci-dessous.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-537">The impacted offers and currencies are below.</span></span> <span data-ttu-id="3d7a4-538">La tarification correcte a été mise à jour et est disponible à la date du 7 janvier 2021 14h00 PST (heure standard du Pacifique).</span><span class="sxs-lookup"><span data-stu-id="3d7a4-538">The correct pricing was updated and available as of January 7, 2021 2PM PST (Pacific Standard Time).</span></span> 

   |<span data-ttu-id="3d7a4-539">**Nom de l'offre**</span><span class="sxs-lookup"><span data-stu-id="3d7a4-539">**Offer name**</span></span>|<span data-ttu-id="3d7a4-540">**ID de l’offre**</span><span class="sxs-lookup"><span data-stu-id="3d7a4-540">**Offer ID**</span></span>|<span data-ttu-id="3d7a4-541">**ID de contenu**</span><span class="sxs-lookup"><span data-stu-id="3d7a4-541">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="3d7a4-542">Microsoft 365 E3</span><span class="sxs-lookup"><span data-stu-id="3d7a4-542">Microsoft 365 E3</span></span>|<span data-ttu-id="3d7a4-543">2b3b8d2d-10aa-4be4-b5fd-7f2feb0c3091</span><span class="sxs-lookup"><span data-stu-id="3d7a4-543">2b3b8d2d-10aa-4be4-b5fd-7f2feb0c3091</span></span>|<span data-ttu-id="3d7a4-544">AAA-35638</span><span class="sxs-lookup"><span data-stu-id="3d7a4-544">AAA-35638</span></span>| 
   |<span data-ttu-id="3d7a4-545">Microsoft 365 Business Basic</span><span class="sxs-lookup"><span data-stu-id="3d7a4-545">Microsoft 365 Business Basic</span></span>|<span data-ttu-id="3d7a4-546">bd938f12-058f-4927-bba3-ae36b1d2501c</span><span class="sxs-lookup"><span data-stu-id="3d7a4-546">bd938f12-058f-4927-bba3-ae36b1d2501c</span></span>|<span data-ttu-id="3d7a4-547">AAA-10624</span><span class="sxs-lookup"><span data-stu-id="3d7a4-547">AAA-10624</span></span>|

<span data-ttu-id="3d7a4-548">Devises impactées :</span><span class="sxs-lookup"><span data-stu-id="3d7a4-548">Currencies impacted:</span></span> 

- <span data-ttu-id="3d7a4-549">Les problèmes de prix de Microsoft 365 E3 étaient limités à ces seules devises : Yen japonais (JPY), Livre sterling (GBP), Union européenne (EUR), Dollar australien (AUD).</span><span class="sxs-lookup"><span data-stu-id="3d7a4-549">Microsoft 365 E3 price issues were limited to only these currencies: Japanese Yen (JPY), Great British Pound (GBP), European Union (EUR), Australian Dollar (AUD).</span></span> 
- <span data-ttu-id="3d7a4-550">Les problèmes de Microsoft 365 Business Basic étaient limités à la devise USD (Dollar américain).</span><span class="sxs-lookup"><span data-stu-id="3d7a4-550">Microsoft 365 Business Basic issues were limited to only United States Dollars (USD).</span></span> 

<span data-ttu-id="3d7a4-551">Les partenaires doivent se référer aux listes de prix de janvier et février disponibles actuellement pour les prix corrects.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-551">Partners should reference the currently available January and February preview price lists for the correct prices.</span></span> 

### <a name="next-steps"></a><span data-ttu-id="3d7a4-552">Étapes suivantes</span><span class="sxs-lookup"><span data-stu-id="3d7a4-552">Next steps</span></span>

- <span data-ttu-id="3d7a4-553">Les partenaires doivent télécharger les fichiers de liste de prix les plus récents à partir de l’Espace partenaires afin d’obtenir les prix corrigés pour janvier et février.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-553">Partners should download the latest price list files from the Partner Center to get the corrected January and February prices.</span></span> 
- <span data-ttu-id="3d7a4-554">Les administrateurs généraux pour les locataires impactés qui ont acheté des abonnements entre le 1er et le 6 janvier seront avertis via un e-mail de l’Espace partenaires avant la fin janvier avec plus de détails.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-554">Global administrators for impacted tenants who have purchased subscriptions between January 1 and January 6 will be notified via a Partner Center email before the end of January with more details.</span></span> 

________________
## <a name="deprecation-and-retirement-of-existing-get-and-put-qualification-apis-for-the-education-customer-validation-process-by-the-end-of-february-2021"></a><a name="2"></a><span data-ttu-id="3d7a4-555">Dépréciation et retrait des API de qualification GET et PUT existantes pour le processus de validation des clients Éducation à la fin du mois de février 2021</span><span class="sxs-lookup"><span data-stu-id="3d7a4-555">Deprecation and retirement of existing GET and PUT Qualification APIs for the Education customer validation process by the end of February 2021</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="3d7a4-556">Public concerné</span><span class="sxs-lookup"><span data-stu-id="3d7a4-556">Impacted audience</span></span>

<span data-ttu-id="3d7a4-557">Partenaires proposant des offres Éducation dans le cadre du programme Fournisseur de solutions Cloud avec l’API Espace partenaires</span><span class="sxs-lookup"><span data-stu-id="3d7a4-557">Partners selling Academic offers through the Cloud Solution Provider program using the Partner Center API</span></span>

### <a name="details"></a><span data-ttu-id="3d7a4-558">Détails</span><span class="sxs-lookup"><span data-stu-id="3d7a4-558">Details</span></span> 

<span data-ttu-id="3d7a4-559">Il s’agit d’une suite aux améliorations des API publiées en décembre 2020.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-559">This is a follow-up to the API enhancements released in December 2020.</span></span> <span data-ttu-id="3d7a4-560">En décembre 2020, de nouvelles API de qualification GET et POST ont été publiées, à la suite de quoi les anciennes API de qualification GET et PUT seront supprimées à la fin du mois de février 2021.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-560">In December 2020 new GET and POST Qualifications APIs were released, and as a result the old GET and PUT Qualification APIs will be retired by the end of February 2021.</span></span> <span data-ttu-id="3d7a4-561">À partir de cette échéance, vous devrez utiliser les nouvelles API de l’Espace partenaires GET et POST pour pouvoir acheter des offres Éducation.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-561">At that time, you will need to use the new GET and POST Partner Center APIs in order to be able to purchase Education offers.</span></span> 

### <a name="next-steps"></a><span data-ttu-id="3d7a4-562">Étapes suivantes</span><span class="sxs-lookup"><span data-stu-id="3d7a4-562">Next steps</span></span>

- <span data-ttu-id="3d7a4-563">Si vous ne l’avez pas déjà fait, passez aux nouvelles API pour une transition réussie et dans les temps.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-563">If you haven't already done so, update to the new APIs for a successful and timely transition.</span></span>
- <span data-ttu-id="3d7a4-564">Passez en revue les nouveaux changements de l’API Espace partenaires et le [Guide dans les ressources de préparation opérationnelle :  Améliorations du processus de validation des clients Éducation dans l’Espace partenaires](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/).</span><span class="sxs-lookup"><span data-stu-id="3d7a4-564">Review the new Partner Center API changes, and [Guide in the Operations Readiness resources:  Partner Center Education customer validation process enhancements](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/).</span></span>
- <span data-ttu-id="3d7a4-565">Partagez ces informations avec les équipes appropriées de votre organisation et avec vos revendeurs pour les aider à anticiper ces changements.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-565">Share this information with the appropriate teams in your organization, and with your resellers, to help them prepare for these changes.</span></span>

_____________

## <a name="dynamics-365-offers-for-february-2021"></a><a name="1"></a><span data-ttu-id="3d7a4-566">Offres Dynamics 365 annoncées pour février 2021</span><span class="sxs-lookup"><span data-stu-id="3d7a4-566">Dynamics 365 offers for February 2021</span></span>

### <a name="categories"></a><span data-ttu-id="3d7a4-567">Catégories</span><span class="sxs-lookup"><span data-stu-id="3d7a4-567">Categories</span></span>

- <span data-ttu-id="3d7a4-568">Date : 04-01-2021</span><span class="sxs-lookup"><span data-stu-id="3d7a4-568">Date: 2021-01-04</span></span>
- <span data-ttu-id="3d7a4-569">Offres</span><span class="sxs-lookup"><span data-stu-id="3d7a4-569">Offers</span></span>

### <a name="summary"></a><span data-ttu-id="3d7a4-570">Résumé</span><span class="sxs-lookup"><span data-stu-id="3d7a4-570">Summary</span></span>

<span data-ttu-id="3d7a4-571">Nouveaux changements dans les offres Dynamics 365 en février 2021.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-571">New Dynamics 365 offer changes will be launched in February 2021.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="3d7a4-572">Public concerné</span><span class="sxs-lookup"><span data-stu-id="3d7a4-572">Impacted audience</span></span>

<span data-ttu-id="3d7a4-573">Partenaires participant aux programmes Fournisseur de solutions Cloud pour les revendeurs indirects, les fournisseurs indirects et les partenaires à facturation directe</span><span class="sxs-lookup"><span data-stu-id="3d7a4-573">Partners participating in the Cloud Solution Provider (CSP) direct bill partner, indirect provider, and indirect reseller incentive programs</span></span>

### <a name="details"></a><span data-ttu-id="3d7a4-574">Détails</span><span class="sxs-lookup"><span data-stu-id="3d7a4-574">Details</span></span>

<span data-ttu-id="3d7a4-575">Microsoft annonce de nouveaux changements dans les offres Dynamics 365 qui prendront effet en février 2021 pour :</span><span class="sxs-lookup"><span data-stu-id="3d7a4-575">Microsoft is announcing upcoming new Dynamics 365 offer changes that will be launched in February 2021 for:</span></span>

- <span data-ttu-id="3d7a4-576">Dynamics 365 Customer Voice Additional Response</span><span class="sxs-lookup"><span data-stu-id="3d7a4-576">Dynamics 365 Customer Voice Additional Response</span></span>
- <span data-ttu-id="3d7a4-577">Dynamics 365 Customer Service Insights End of Life</span><span class="sxs-lookup"><span data-stu-id="3d7a4-577">Dynamics 365 Customer Service Insights End of Life</span></span>
- <span data-ttu-id="3d7a4-578">Dynamics 365 Cloud AX Migration Offer IDs change</span><span class="sxs-lookup"><span data-stu-id="3d7a4-578">Dynamics 365 Cloud AX Migration Offer IDs change</span></span>

<span data-ttu-id="3d7a4-579">**Dynamics 365 Customer Voice Additional Response**</span><span class="sxs-lookup"><span data-stu-id="3d7a4-579">**Dynamics 365 Customer Voice Additional Response**</span></span>

<span data-ttu-id="3d7a4-580">Le 1er février 2021, Microsoft va créer une nouvelle offre « Additional Response » avec un droit à 1 000 réponses pour remplacer l’offre existante de 2 000 réponses à des enquêtes, qui ne sera plus à la vente à compter du 1er février 2021.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-580">On February 1, 2021, Microsoft will create a new "Additional Response" offer with 1-K response entitlement to replace the existing offer with 2-K Survey Responses, the end of sale of which will be on February 1, 2021.</span></span>

<span data-ttu-id="3d7a4-581">Consultez l’onglet « Customer Voice Addl Resp » dans le [document Excel Dynamics CSP Offers-Février 2021](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls) pour obtenir le détail des références SKU.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-581">See the "Customer Voice Addl Resp" tab in the [Dynamics CSP Offers-February 2021 Excel document](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls) for the SKU details.</span></span> <span data-ttu-id="3d7a4-582">Pour plus d’informations, consultez la [page d’accueil de Microsoft Dynamics 365 Customer Voice](https://dynamics.microsoft.com/customer-voice/overview/).</span><span class="sxs-lookup"><span data-stu-id="3d7a4-582">View the [Microsoft Dynamics 365 Customer Voice Home Page](https://dynamics.microsoft.com/customer-voice/overview/) for more information.</span></span>

<span data-ttu-id="3d7a4-583">**Dynamics 365 Customer Service Insights End of Life**</span><span class="sxs-lookup"><span data-stu-id="3d7a4-583">**Dynamics 365 Customer Service Insights End of Life**</span></span>

<span data-ttu-id="3d7a4-584">Le 1er février 2021, les produits suivants auront le statut Fin de vie :</span><span class="sxs-lookup"><span data-stu-id="3d7a4-584">On February 1, 2021, the following products will be changed to end-of-life:</span></span>

- <span data-ttu-id="3d7a4-585">Dynamics 365 Customer Service Insights (comprenant « Additional Cases »)</span><span class="sxs-lookup"><span data-stu-id="3d7a4-585">Dynamics 365 Customer Service Insights (including "Additional Cases")</span></span>
- <span data-ttu-id="3d7a4-586">Dynamics 365 Virtual Agent for Customer Service</span><span class="sxs-lookup"><span data-stu-id="3d7a4-586">Dynamics 365 Virtual Agent for Customer Service</span></span>

<span data-ttu-id="3d7a4-587">L’expérience autonome « Customer Service Insights » est transférée à « Dynamics 365 Customer Service », où les clients peuvent trouver les mêmes fonctionnalités étroitement incorporées dans les expériences du service client.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-587">The "Customer Service Insights" standalone experience is moving into "Dynamics 365 Customer Service", where customers can find the same capabilities deeply embedded in the customer service experiences.</span></span>  

<span data-ttu-id="3d7a4-588">Consultez l’onglet « Customer Service Insights » dans le [document Excel Dynamics CSP Offers-Février 2021](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls) pour obtenir le détail des références SKU.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-588">See the "Customer Service Insights" tab in the [Dynamics CSP Offers-February 2021 Excel document](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-february-2021-xls) for the SKU details.</span></span> <span data-ttu-id="3d7a4-589">Pour plus d’informations, consultez la [page d’accueil de Microsoft Dynamics Customer Service](https://dynamics.microsoft.com/customer-service/overview/).</span><span class="sxs-lookup"><span data-stu-id="3d7a4-589">Visit the [Microsoft Dynamics Customer Service Home Page](https://dynamics.microsoft.com/customer-service/overview/) for more information.</span></span>

<span data-ttu-id="3d7a4-590">**Dynamics 365 Cloud AX migration offer IDs**</span><span class="sxs-lookup"><span data-stu-id="3d7a4-590">**Dynamics 365 Cloud AX migration offer IDs**</span></span>

<span data-ttu-id="3d7a4-591">Ces références SKU ont été supprimées de la liste des prix finaux du 1er janvier 2021 et ne pourront pas être commandées à compter de cette date.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-591">These SKUs have been removed from the January 1, 2021 final price list and will not be available to order at this time.</span></span> 

   |<span data-ttu-id="3d7a4-592">**Nom de l'offre**</span><span class="sxs-lookup"><span data-stu-id="3d7a4-592">**Offer name**</span></span>|<span data-ttu-id="3d7a4-593">**ID de l’offre**</span><span class="sxs-lookup"><span data-stu-id="3d7a4-593">**Offer ID**</span></span>|
   |-------------------|:------|
   |<span data-ttu-id="3d7a4-594">Dynamics 365 Finance for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="3d7a4-594">Dynamics 365 Finance for AX Migration Program</span></span>|<span data-ttu-id="3d7a4-595">7fbd1115-a4c1-4cf9-b881-40c4187ca581</span><span class="sxs-lookup"><span data-stu-id="3d7a4-595">7fbd1115-a4c1-4cf9-b881-40c4187ca581</span></span>|
   |<span data-ttu-id="3d7a4-596">Dynamics 365 Supply Chain Management for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="3d7a4-596">Dynamics 365 Supply Chain Management for AX Migration Program</span></span>|<span data-ttu-id="3d7a4-597">a3c62c0e-4f8a-4fc9-a47e-dec3310529d0</span><span class="sxs-lookup"><span data-stu-id="3d7a4-597">a3c62c0e-4f8a-4fc9-a47e-dec3310529d0</span></span>|
   |<span data-ttu-id="3d7a4-598">Dynamics 365 Commerce for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="3d7a4-598">Dynamics 365 Commerce for AX Migration Program</span></span>|<span data-ttu-id="3d7a4-599">97e98de6-24a8-4282-bad6-9d1a874e90a4</span><span class="sxs-lookup"><span data-stu-id="3d7a4-599">97e98de6-24a8-4282-bad6-9d1a874e90a4</span></span>|
   |<span data-ttu-id="3d7a4-600">Dynamics 365 Finance Attach to Qualifying Dynamics 365 Base Offer for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="3d7a4-600">Dynamics 365 Finance Attach to Qualifying Dynamics 365 Base Offer for AX Migration Program</span></span>|<span data-ttu-id="3d7a4-601">69d789e8-1e93-4dee-86b2-3ddfb03c08b9</span><span class="sxs-lookup"><span data-stu-id="3d7a4-601">69d789e8-1e93-4dee-86b2-3ddfb03c08b9</span></span>|
   |<span data-ttu-id="3d7a4-602">Dynamics 365 Supply Chain Management Attach to Qualifying Dynamics 365 Base Offer for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="3d7a4-602">Dynamics 365 Supply Chain Management Attach to Qualifying Dynamics 365 Base Offer for AX Migration Program</span></span>|<span data-ttu-id="3d7a4-603">c897adce-2964-4d24-abc3-7f7ad4b6a80d</span><span class="sxs-lookup"><span data-stu-id="3d7a4-603">c897adce-2964-4d24-abc3-7f7ad4b6a80d</span></span>|
   |<span data-ttu-id="3d7a4-604">Dynamics 365 Commerce Attach to Qualifying Dynamics 365 Base Offer for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="3d7a4-604">Dynamics 365 Commerce Attach to Qualifying Dynamics 365 Base Offer for AX Migration Program</span></span>|<span data-ttu-id="3d7a4-605">ba1fe561-cfda-405a-a25d-ecda3bd3cba7</span><span class="sxs-lookup"><span data-stu-id="3d7a4-605">ba1fe561-cfda-405a-a25d-ecda3bd3cba7</span></span>|
   |<span data-ttu-id="3d7a4-606">Dynamics 365 Operations – Activity for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="3d7a4-606">Dynamics 365 Operations – Activity for AX Migration Program</span></span>|<span data-ttu-id="3d7a4-607">177e954e-1fff-4941-8967-55a47e36e1ce</span><span class="sxs-lookup"><span data-stu-id="3d7a4-607">177e954e-1fff-4941-8967-55a47e36e1ce</span></span>|
   |<span data-ttu-id="3d7a4-608">Dynamics 365 Operations – Device for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="3d7a4-608">Dynamics 365 Operations – Device for AX Migration Program</span></span>|<span data-ttu-id="3d7a4-609">8c8b7c8f-cb3a-4737-8319-1752938c7be3</span><span class="sxs-lookup"><span data-stu-id="3d7a4-609">8c8b7c8f-cb3a-4737-8319-1752938c7be3</span></span>|
   |<span data-ttu-id="3d7a4-610">Dynamics 365 Team Members for AX Migration Program</span><span class="sxs-lookup"><span data-stu-id="3d7a4-610">Dynamics 365 Team Members for AX Migration Program</span></span>|<span data-ttu-id="3d7a4-611">1eb3ad0b-9de3-419d-8bfe-0d61bdd945b2</span><span class="sxs-lookup"><span data-stu-id="3d7a4-611">1eb3ad0b-9de3-419d-8bfe-0d61bdd945b2</span></span>|

### <a name="next-steps"></a><span data-ttu-id="3d7a4-612">Étapes suivantes</span><span class="sxs-lookup"><span data-stu-id="3d7a4-612">Next steps</span></span>

<span data-ttu-id="3d7a4-613">Passez en revue les ressources sur ce sujet et partagez-les avec les parties prenantes appropriées de votre organisation.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-613">Review the resources about this topic and share them with the appropriate stakeholders in your organization.</span></span> 

### <a name="questions"></a><span data-ttu-id="3d7a4-614">Vous avez des questions ?</span><span class="sxs-lookup"><span data-stu-id="3d7a4-614">Questions?</span></span>

<span data-ttu-id="3d7a4-615">Si vous avez d’autres questions sur ces offres, consultez vos communautés Yammer appropriées.</span><span class="sxs-lookup"><span data-stu-id="3d7a4-615">For any further questions about these offers, check your relevant Yammer communities.</span></span>
