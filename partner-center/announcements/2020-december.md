...
### <a name="categories"></a><span data-ttu-id="6c24f-107">Catégories</span><span class="sxs-lookup"><span data-stu-id="6c24f-107">Categories</span></span>
...
### <a name="impacted-audience"></a><span data-ttu-id="6c24f-155">Public concerné</span><span class="sxs-lookup"><span data-stu-id="6c24f-155">Impacted audience</span></span>
...
<span data-ttu-id="6c24f-168">En résumé, les fichiers des prix ci-dessous seront disponibles comme d’habitude le 31 décembre 2020 à environ 18h00 (heure standard du Pacifique) :</span><span class="sxs-lookup"><span data-stu-id="6c24f-168">In summary, the below pricing files will be available as usual on December 31, 2020 at approximately 6PM PST:</span></span>
...
- <span data-ttu-id="6c24f-182">Date : 21-12-2020</span><span class="sxs-lookup"><span data-stu-id="6c24f-182">Date: 2020-12-21</span></span>
...
- <span data-ttu-id="6c24f-204">Date : 17-12-2020</span><span class="sxs-lookup"><span data-stu-id="6c24f-204">Date: 2020-12-17</span></span>
...
- <span data-ttu-id="6c24f-215">Date : 17-12-2020</span><span class="sxs-lookup"><span data-stu-id="6c24f-215">Date: 2020-12-17</span></span>
...
2. <span data-ttu-id="6c24f-226">Le partenaire fait affaire avec des clients nouveaux ou déjà existants dans les pays suivants :</span><span class="sxs-lookup"><span data-stu-id="6c24f-226">The partner does business with new or existing customers in the following countries:</span></span>
    ...
    - <span data-ttu-id="6c24f-234">Irak</span><span class="sxs-lookup"><span data-stu-id="6c24f-234">Iraq</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="6c24f-255">Étapes suivantes</span><span class="sxs-lookup"><span data-stu-id="6c24f-255">Next steps</span></span>
...
### <a name="categories"></a><span data-ttu-id="6c24f-266">Catégories</span><span class="sxs-lookup"><span data-stu-id="6c24f-266">Categories</span></span>
...
<span data-ttu-id="6c24f-280">Voici ce qui se produira également à la même date :</span><span class="sxs-lookup"><span data-stu-id="6c24f-280">The following will also happen on the same date:</span></span>
...
### <a name="change-log"></a><span data-ttu-id="6c24f-302">Journal des modifications :</span><span class="sxs-lookup"><span data-stu-id="6c24f-302">Change Log:</span></span>
...
- <span data-ttu-id="6c24f-345">ID de contenu : SEQ-00016</span><span class="sxs-lookup"><span data-stu-id="6c24f-345">Material ID: SEQ-00016</span></span>
...
<span data-ttu-id="6c24f-411">Les offres ci-dessous ont été incluses dans la matrice de la liste des offres par erreur.</span><span class="sxs-lookup"><span data-stu-id="6c24f-411">Below offers were in the offer list matrix in error.</span></span> <span data-ttu-id="6c24f-412">Elles ne sont pas disponibles, et aucune date n’a encore été fixée quant à leur éventuelle disponibilité.</span><span class="sxs-lookup"><span data-stu-id="6c24f-412">They are not available, there is not target date yet for availability.</span></span> <span data-ttu-id="6c24f-413">Les partenaires ne doivent pas tenir compte de ces éléments de ligne.</span><span class="sxs-lookup"><span data-stu-id="6c24f-413">Partners should ignore these line items.</span></span>

   |<span data-ttu-id="6c24f-414">**Nom de l'offre**</span><span class="sxs-lookup"><span data-stu-id="6c24f-414">**Offer name**</span></span>|<span data-ttu-id="6c24f-415">**ID de l’offre**</span><span class="sxs-lookup"><span data-stu-id="6c24f-415">**Offer ID**</span></span>|
   |-------------------|:------|
   |<span data-ttu-id="6c24f-416">Opérations Dynamics 365 – Capacité de base de données (tarif sans marge)</span><span class="sxs-lookup"><span data-stu-id="6c24f-416">Dynamics 365 Operations - Database Capacity (Nonprofits Pricing)</span></span>|<span data-ttu-id="6c24f-417">1d3f4d81-89b9-419e-a880-31b2c50b8d66</span><span class="sxs-lookup"><span data-stu-id="6c24f-417">1d3f4d81-89b9-419e-a880-31b2c50b8d66</span></span>|
   |<span data-ttu-id="6c24f-418">Opérations Dynamics 365 – Capacité de fichier (tarif sans marge)</span><span class="sxs-lookup"><span data-stu-id="6c24f-418">Dynamics 365 Operations - File Capacity (Nonprofits Pricing)</span></span>|<span data-ttu-id="6c24f-419">dc173a86-285b-444c-881e-3ece531f67da</span><span class="sxs-lookup"><span data-stu-id="6c24f-419">dc173a86-285b-444c-881e-3ece531f67da</span></span>|

#### <a name="powerapps-offer"></a><span data-ttu-id="6c24f-420">Offre PowerApps</span><span class="sxs-lookup"><span data-stu-id="6c24f-420">Powerapps offer</span></span>

<span data-ttu-id="6c24f-421">Cette offre a été incluse dans la matrice de la liste des offres, mais pas dans le tarif de décembre.</span><span class="sxs-lookup"><span data-stu-id="6c24f-421">This offer was included in the offer list matrix but not the December price list.</span></span> <span data-ttu-id="6c24f-422">L’offre est disponible et son prix figure dans le fichier du tarif du mois précédent (novembre).</span><span class="sxs-lookup"><span data-stu-id="6c24f-422">The offer is available and pricing can be found in the previous month's price list November file.</span></span> <span data-ttu-id="6c24f-423">Cette offre doit être rajoutée au tarif de janvier.</span><span class="sxs-lookup"><span data-stu-id="6c24f-423">This offer should be added back to the January price list.</span></span>

   |<span data-ttu-id="6c24f-424">**Nom de l'offre**</span><span class="sxs-lookup"><span data-stu-id="6c24f-424">**Offer name**</span></span>|<span data-ttu-id="6c24f-425">**ID de l’offre**</span><span class="sxs-lookup"><span data-stu-id="6c24f-425">**Offer ID**</span></span>|
   |-------------------|:------|
   |<span data-ttu-id="6c24f-426">Plan Power Apps par application</span><span class="sxs-lookup"><span data-stu-id="6c24f-426">Power Apps per app plan</span></span>|<span data-ttu-id="6c24f-427">5e1087b6-246b-4503-b88a-b60bdf0b3840</span><span class="sxs-lookup"><span data-stu-id="6c24f-427">5e1087b6-246b-4503-b88a-b60bdf0b3840</span></span>|

### <a name="next-steps"></a><span data-ttu-id="6c24f-428">Étapes suivantes</span><span class="sxs-lookup"><span data-stu-id="6c24f-428">Next steps</span></span>

<span data-ttu-id="6c24f-429">Consultez régulièrement les notes de publication, car si d’autres problèmes sont découverts, ils seront ajoutés à cette annonce.</span><span class="sxs-lookup"><span data-stu-id="6c24f-429">Check release notes often as other issues are uncovered they will be appended to this announcement.</span></span>

### <a name="last-updated"></a><span data-ttu-id="6c24f-430">Dernière mise à jour</span><span class="sxs-lookup"><span data-stu-id="6c24f-430">Last updated</span></span>

<span data-ttu-id="6c24f-431">8 décembre 2020</span><span class="sxs-lookup"><span data-stu-id="6c24f-431">December 8, 2020</span></span>

______________

## <a name="an-update-of-the-us-microsoft-365-business-voice-with-calling-plan-offer-is-coming-soon"></a><a name="2"></a><span data-ttu-id="6c24f-432">Une mise à jour de l’offre Microsoft 365 Business Voice US avec forfait d’appels sort prochainement aux É.-U.</span><span class="sxs-lookup"><span data-stu-id="6c24f-432">An update of the US Microsoft 365 Business Voice with Calling Plan offer is coming soon</span></span>

### <a name="categories"></a><span data-ttu-id="6c24f-433">Catégories</span><span class="sxs-lookup"><span data-stu-id="6c24f-433">Categories</span></span>

- <span data-ttu-id="6c24f-434">Date : 3/12/2020</span><span class="sxs-lookup"><span data-stu-id="6c24f-434">Date: 2020-12-3</span></span>
- <span data-ttu-id="6c24f-435">Offres/marchés</span><span class="sxs-lookup"><span data-stu-id="6c24f-435">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="6c24f-436">Résumé</span><span class="sxs-lookup"><span data-stu-id="6c24f-436">Summary</span></span> 

<span data-ttu-id="6c24f-437">Le 1er janvier 2021, Microsoft amorcera la transition des partenaires et clients des États-Unis vers une nouvelle offre Microsoft 365 Business Voice avec forfait d’appels.</span><span class="sxs-lookup"><span data-stu-id="6c24f-437">On January 1, 2021, Microsoft will begin transitioning US partners and customers to a new Microsoft 365 Business Voice with Calling Plan offer.</span></span> <span data-ttu-id="6c24f-438">Aucune action n’est nécessaire de la part des partenaires.</span><span class="sxs-lookup"><span data-stu-id="6c24f-438">No partner action is required.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="6c24f-439">Public concerné</span><span class="sxs-lookup"><span data-stu-id="6c24f-439">Impacted Audience</span></span> 

<span data-ttu-id="6c24f-440">Tous les partenaires effectuant des transactions commerciales dans le cadre du programme Fournisseur de solutions cloud</span><span class="sxs-lookup"><span data-stu-id="6c24f-440">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="details"></a><span data-ttu-id="6c24f-441">Détails</span><span class="sxs-lookup"><span data-stu-id="6c24f-441">Details</span></span>

<span data-ttu-id="6c24f-442">Microsoft remplacera l’offre existante Business Voice avec forfait d’appels aux États-Unis par une nouvelle offre visant à répondre aux besoins internes pour les produits telco.</span><span class="sxs-lookup"><span data-stu-id="6c24f-442">Microsoft will replace the existing Business Voice with Calling plan offer in the US with a new offer to support internal requirements for telco products.</span></span> <span data-ttu-id="6c24f-443">La nouvelle offre proposera le même ensemble de fonctionnalités et le même tarif.</span><span class="sxs-lookup"><span data-stu-id="6c24f-443">The new offer will have the same feature set and pricing.</span></span> <span data-ttu-id="6c24f-444">Les modifications apportées à l’offre sont internes à Microsoft et ne doivent pas affecter la manière dont les partenaires CSP commercialisent, vendent ou assurent le support de l’offre Business Voice avec forfait d’appels.</span><span class="sxs-lookup"><span data-stu-id="6c24f-444">The offer changes are internal to Microsoft and should not affect the way that CSP partners market, sell, or support the Business Voice with Calling Plan offer.</span></span> <span data-ttu-id="6c24f-445">La modification s’appliquera uniquement à cette offre.</span><span class="sxs-lookup"><span data-stu-id="6c24f-445">The change will only apply to this offer.</span></span>

<span data-ttu-id="6c24f-446">Pour les nouvelles ventes, vous utiliserez la nouvelle offre à partir du 1er janvier 2021.</span><span class="sxs-lookup"><span data-stu-id="6c24f-446">For new sales, you will use the new offer starting on January 1, 2021.</span></span> <span data-ttu-id="6c24f-447">L’ancienne offre sera remplacée par la nouvelle dans le tarif.</span><span class="sxs-lookup"><span data-stu-id="6c24f-447">The old offer will be replaced by the new offer on the price list.</span></span>

<span data-ttu-id="6c24f-448">Les clients existants seront automatiquement versés dans la nouvelle offre à la date de renouvellement.</span><span class="sxs-lookup"><span data-stu-id="6c24f-448">Existing customers will be automatically transitioned to the new offer upon their renewal date.</span></span> <span data-ttu-id="6c24f-449">Aucune action n’est nécessaire de la part des partenaires et des clients qui renouvellent l’offre.</span><span class="sxs-lookup"><span data-stu-id="6c24f-449">No action is required from partners and renewing customers.</span></span>


<span data-ttu-id="6c24f-450">\*\*Détails de la nouvelle offre</span><span class="sxs-lookup"><span data-stu-id="6c24f-450">\*\*New offer details</span></span>
 
   |<span data-ttu-id="6c24f-451">**Nom de l'offre**</span><span class="sxs-lookup"><span data-stu-id="6c24f-451">**Offer name**</span></span>|<span data-ttu-id="6c24f-452">**ID de l’offre**</span><span class="sxs-lookup"><span data-stu-id="6c24f-452">**Offer ID**</span></span>|<span data-ttu-id="6c24f-453">**ID de contenu**</span><span class="sxs-lookup"><span data-stu-id="6c24f-453">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="6c24f-454">Microsoft 365 Business Voice (É.-U.)</span><span class="sxs-lookup"><span data-stu-id="6c24f-454">Microsoft 365 Business Voice (US)</span></span>|<span data-ttu-id="6c24f-455">86713ec1-ad33-42cf-a1ce-8397d4d875fe</span><span class="sxs-lookup"><span data-stu-id="6c24f-455">86713ec1-ad33-42cf-a1ce-8397d4d875fe</span></span>|<span data-ttu-id="6c24f-456">PZW-00023</span><span class="sxs-lookup"><span data-stu-id="6c24f-456">PZW-00023</span></span>|
   
<span data-ttu-id="6c24f-457">\*\*Détails de l’ancienne offre</span><span class="sxs-lookup"><span data-stu-id="6c24f-457">\*\*Old offer details</span></span>

   |<span data-ttu-id="6c24f-458">**Nom de l'offre**</span><span class="sxs-lookup"><span data-stu-id="6c24f-458">**Offer name**</span></span>|<span data-ttu-id="6c24f-459">**ID de l’offre**</span><span class="sxs-lookup"><span data-stu-id="6c24f-459">**Offer ID**</span></span>|<span data-ttu-id="6c24f-460">**ID de contenu**</span><span class="sxs-lookup"><span data-stu-id="6c24f-460">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="6c24f-461">Microsoft 365 Business Voice (É.-U.)</span><span class="sxs-lookup"><span data-stu-id="6c24f-461">Microsoft 365 Business Voice (US)</span></span>|<span data-ttu-id="6c24f-462">9f9f2c7b-c961-402b-9421-8e3c9207eeb3</span><span class="sxs-lookup"><span data-stu-id="6c24f-462">9f9f2c7b-c961-402b-9421-8e3c9207eeb3</span></span>|<span data-ttu-id="6c24f-463">PZW-00009</span><span class="sxs-lookup"><span data-stu-id="6c24f-463">PZW-00009</span></span>|

### <a name="next-steps"></a><span data-ttu-id="6c24f-464">Étapes suivantes</span><span class="sxs-lookup"><span data-stu-id="6c24f-464">Next steps</span></span>

<span data-ttu-id="6c24f-465">Familiarisez-vous avec le tarif et partagez ces informations avec tous les contacts appropriés de votre organisation.</span><span class="sxs-lookup"><span data-stu-id="6c24f-465">Familiarize yourself with the price list and share this information with all appropriate contacts in your organization.</span></span>

______________

## <a name="now-live-partner-center-api-updates-and-user-interface-enhancements-for-the-education-customer-validation-process"></a><a name="1"></a><span data-ttu-id="6c24f-466">Disponible dès maintenant : Mises à jour des API de l’Espace partenaires et améliorations de l’interface utilisateur pour le processus de validation des clients Éducation</span><span class="sxs-lookup"><span data-stu-id="6c24f-466">Now live: Partner Center API updates and user interface enhancements for the Education customer validation process</span></span>

### <a name="categories"></a><span data-ttu-id="6c24f-467">Catégories</span><span class="sxs-lookup"><span data-stu-id="6c24f-467">Categories</span></span>

- <span data-ttu-id="6c24f-468">Date : 3/12/2020</span><span class="sxs-lookup"><span data-stu-id="6c24f-468">Date: 2020-12-3</span></span>
- <span data-ttu-id="6c24f-469">Fonctionnalités</span><span class="sxs-lookup"><span data-stu-id="6c24f-469">Capabilities</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="6c24f-470">Public concerné</span><span class="sxs-lookup"><span data-stu-id="6c24f-470">Impacted Audience</span></span> 

<span data-ttu-id="6c24f-471">Partenaires proposant des offres Éducation dans le cadre du programme Fournisseur de solutions Cloud</span><span class="sxs-lookup"><span data-stu-id="6c24f-471">Partners selling Academic offers through the Cloud Solution Provider program</span></span>

### <a name="summary"></a><span data-ttu-id="6c24f-472">Résumé</span><span class="sxs-lookup"><span data-stu-id="6c24f-472">Summary</span></span> 

<span data-ttu-id="6c24f-473">Chez Microsoft, la confiance est notre priorité.</span><span class="sxs-lookup"><span data-stu-id="6c24f-473">Microsoft runs on trust.</span></span> <span data-ttu-id="6c24f-474">C’est pourquoi nous nous engageons à fournir une méthode de validation des clients conforme, sûre et sécurisée pour les transactions d’offres Éducation dans le programme Fournisseur de solutions Cloud.</span><span class="sxs-lookup"><span data-stu-id="6c24f-474">We are committed to providing a compliant, safe, and secure method of customer validation for transacting Academic offers in the Cloud Solution Provider program.</span></span> <span data-ttu-id="6c24f-475">Dans le cadre de cet engagement, nous allons introduire des améliorations de l’interface utilisateur et de l’API de l’Espace partenaires pour accroître la clarté et la visibilité du processus de validation des clients et permettre la saisie de données plus précises, ce qui améliorera la validation des clients.</span><span class="sxs-lookup"><span data-stu-id="6c24f-475">As part of this commitment, we are introducing Partner Center API and user interface enhancements that will add clarity and visibility into the customer vetting process as well as the ability to input more accurate data, which will drive improved customer vetting success.</span></span> 

<span data-ttu-id="6c24f-476">**Améliorations de l’Espace partenaires**</span><span class="sxs-lookup"><span data-stu-id="6c24f-476">**Partner Center enhancements**</span></span> 

- <span data-ttu-id="6c24f-477">Nouvelles API de qualification GET et POST pour prendre en charge la saisie de données précises et améliorer le processus de validation des clients Éducation par Microsoft.</span><span class="sxs-lookup"><span data-stu-id="6c24f-477">New GET and POST Qualifications APIs to support accurate data entry and improve the Education customer validation process by Microsoft.</span></span> 

- <span data-ttu-id="6c24f-478">Améliorations de l’interface utilisateur pour prendre en charge la saisie de données précises et améliorer le processus de validation des clients Éducation par Microsoft.</span><span class="sxs-lookup"><span data-stu-id="6c24f-478">User interface enhancements to support accurate data entry and improve the Education customer validation process by Microsoft.</span></span> 

<span data-ttu-id="6c24f-479">**Désapprobation des API de qualification GET et PUT**</span><span class="sxs-lookup"><span data-stu-id="6c24f-479">**Deprecation of existing GET and PUT Qualification APIs**</span></span> 

<span data-ttu-id="6c24f-480">Les API de qualification GET et PUT seront mises hors service **avant la fin du mois de février 2021**.</span><span class="sxs-lookup"><span data-stu-id="6c24f-480">The existing GET and PUT Qualification APIs will retire **before the end of February 2021**.</span></span> <span data-ttu-id="6c24f-481">À ce moment-là, vous devrez avoir opéré la transition vers les nouvelles API de l’Espace partenaires GET et POST pour pouvoir acheter des offres Éducation.</span><span class="sxs-lookup"><span data-stu-id="6c24f-481">At that time, you will need to have transitioned to the new GET and POST Partner Center APIs in order to be able to purchase Education offers.</span></span>  

<span data-ttu-id="6c24f-482">Test</span><span class="sxs-lookup"><span data-stu-id="6c24f-482">**Testing**</span></span> 

<span data-ttu-id="6c24f-483">Pour mieux comprendre les API et les données nécessaires à la réussite de la validation des clients, les partenaires peuvent tester ces améliorations.</span><span class="sxs-lookup"><span data-stu-id="6c24f-483">To gain a better understanding of the APIs and data entry required for successful customer validation, partners can test these enhancements.</span></span> <span data-ttu-id="6c24f-484">Les partenaires qui souhaitent participer au test doivent télécharger le [Guide de test des clients Éducation de l’Espace partenaires](https://partner.microsoft.com/resources/detail/partner-center-edu-testing-guide-pdf) pour savoir comment se préparer et s’inscrire et à quoi s’attendre pendant la phase de test.</span><span class="sxs-lookup"><span data-stu-id="6c24f-484">Partners who want to participate in the testing should download the [Partner Center Education customer testing guide](https://partner.microsoft.com/resources/detail/partner-center-edu-testing-guide-pdf) for directions on how to prepare, sign up, and for information on what to expect during the testing phase.</span></span>

<span data-ttu-id="6c24f-485">**Clients des bibliothèques et musées**</span><span class="sxs-lookup"><span data-stu-id="6c24f-485">**Library and Museum customers**</span></span> 

<span data-ttu-id="6c24f-486">En plus des améliorations ci-dessus, nous sommes ravis d’annoncer la mise en place d’offres à prix Éducation pour les clients des bibliothèques et musées, élargissant ainsi le nombre de clients Éducation auxquels vous pouvez proposer des offres Fournisseur de solutions Cloud.</span><span class="sxs-lookup"><span data-stu-id="6c24f-486">In addition to the above enhancements, we are excited to announce that we will enable Academic-priced offers for Library and Museum customers, expanding the Education customers with whom you can transact CSP offers.</span></span> 

<span data-ttu-id="6c24f-487">Microsoft se réserve le droit d’examiner le status d’un client ou d’un client proposé pour déterminer s’il répond aux critères d’un utilisateur Éducation.</span><span class="sxs-lookup"><span data-stu-id="6c24f-487">Microsoft reserves the right to review the status of any customer or proposed customer as a qualified educational user.</span></span> <span data-ttu-id="6c24f-488">Pour plus d’informations, consultez les [critères que doit remplir un utilisateur pour bénéficier des offres Éducation](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7).</span><span class="sxs-lookup"><span data-stu-id="6c24f-488">See the [Academic Qualified Education User Requirements](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7) for full details.</span></span> 

### <a name="next-stepsadditional-resources"></a><span data-ttu-id="6c24f-489">Étapes suivantes/ressources supplémentaires</span><span class="sxs-lookup"><span data-stu-id="6c24f-489">Next steps/additional resources</span></span>

- <span data-ttu-id="6c24f-490">Passez en revue la nouvelle interface utilisateur de l’Espace partenaires, les modifications apportées aux API et le guide dans les ressources de préparation opérationnelle :  Améliorations du processus de [validation des clients Éducation dans l’Espace partenaires](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/)</span><span class="sxs-lookup"><span data-stu-id="6c24f-490">Review the new Partner Center User Interface, API changes, and Guide in the Operations Readiness resources:  [Partner Center Education customer validation](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/) process enhancements</span></span> 

- <span data-ttu-id="6c24f-491">Veillez à ce que les [critères que doit remplir un utilisateur pour bénéficier des offres Éducation](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7) soient connus dans votre organisation.</span><span class="sxs-lookup"><span data-stu-id="6c24f-491">Ensure your organization is familiar with the [Academic Qualified Education User requirements](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7).</span></span> 

- <span data-ttu-id="6c24f-492">Partagez ces informations avec les équipes appropriées au sein de votre organisation et avec vos revendeurs pour les aider à anticiper ces changements.</span><span class="sxs-lookup"><span data-stu-id="6c24f-492">Share this information with the appropriate teams within your organization, and with your resellers, to help them prepare for these changes.</span></span> 

### <a name="change-log"></a><span data-ttu-id="6c24f-493">Journal des modifications</span><span class="sxs-lookup"><span data-stu-id="6c24f-493">Change Log</span></span> 

<span data-ttu-id="6c24f-494">_ 31 août 2020 :  Première publication</span><span class="sxs-lookup"><span data-stu-id="6c24f-494">_ August 31, 2020:  Original publication</span></span> 

- <span data-ttu-id="6c24f-495">25 septembre 2020 :  Ajout de la mise à jour concernant la fenêtre de test</span><span class="sxs-lookup"><span data-stu-id="6c24f-495">September 25, 2020:  Test window update added</span></span> 

- <span data-ttu-id="6c24f-496">4 octobre 2020 : Rappel d’inscription au test</span><span class="sxs-lookup"><span data-stu-id="6c24f-496">October 4, 2020: Reminder to sign up for testing</span></span> 

- <span data-ttu-id="6c24f-497">10 novembre 2020 : Rappel d’inscription au test</span><span class="sxs-lookup"><span data-stu-id="6c24f-497">November 10, 2020: Reminder to sign up for testing</span></span> 

- <span data-ttu-id="6c24f-498">3 décembre 2020 : Mise à disposition des mises à jour d’API</span><span class="sxs-lookup"><span data-stu-id="6c24f-498">December 3, 2020: API updates live</span></span>