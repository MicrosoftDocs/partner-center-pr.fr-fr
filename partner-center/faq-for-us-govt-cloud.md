...
**La tarification client est-elle identique à celle du CSP commercial ?**
...
*Contrat de distribution Microsoft Cloud (MCDA)*
...
**La facturation est-elle modifiée ?**
...
**Pour les données hébergées dans des centres de données commerciaux, est-il possible de passer à Microsoft Cloud pour le gouvernement des États-Unis ?**
...
**Le programme CSP pour les Microsoft Cloud pour le secteur public américain offre-t-il tous les services Azure ?**
...
**Que dois-je faire pour développer avec le programme CSP pour Microsoft Cloud pour le gouvernement des États-Unis ?**
...
**Existe-t-il une solution de contournement pour les API qui ne sont pas disponibles dans le programme CSP pour Microsoft Cloud pour le gouvernement des États-Unis ?**
...
**Où dois-je aller si j’ai encore des questions ?**
