...
<a name=""></a>=======
---
title: Gérer votre compte Espace partenaires ms. ms.topic: article ms.date: 05/21/2020 ms.service: partner-dashboard ms.subservice: partnercenter-csp description: Découvrez comment gérer le profil, le catalogue, les informations bancaires et fiscales, ainsi que les rôles et les autorisations de votre entreprise dans l’Espace partenaires.
